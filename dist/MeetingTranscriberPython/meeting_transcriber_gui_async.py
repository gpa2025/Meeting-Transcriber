...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, 
                            ...
                            QFrame, QScrollArea, QMenuBar, QAction)
...
class EnhancedMeetingTranscriberGUI(QMainWindow):
    ...
    def setup_menu_bar(self):
        ...
        # About action
        about_action = help_menu.addAction('About Meeting Transcriber')
        about_action.triggered.connect(self.show_about_dialog)
        
        # Async Features Guide action
        async_guide_action = help_menu.addAction('Async Features Guide')
        async_guide_action.triggered.connect(self.show_async_guide)
    ...
    def show_about_dialog(self):
        """Show the about dialog with async features information"""
        about_text = """
        <h2>Meeting Transcriber - Enhanced Async Edition</h2>
        <p><b>Version:</b> 1.1 - Async Features</p>
        ...
        <p>The most advanced meeting transcription tool with professional async processing capabilities.</p>
        
        <h3>🚀 Enhanced Async Features:</h3>
        <ul>
        <li><b>⚡ Non-blocking Processing:</b> UI stays responsive during transcription</li>
        <li><b>📊 Real-time Progress:</b> Live progress bars with detailed status updates</li>
        <li><b>❌ Task Cancellation:</b> Stop operations anytime with graceful cleanup</li>
        <li><b>🔄 Concurrent Processing:</b> Handle 3-5 files simultaneously</li>
        <li><b>📋 Professional Interface:</b> Tabbed layout with progress monitoring</li>
        <li><b>💾 Settings Persistence:</b> Auto-save configuration between sessions</li>
        <li><b>🛡️ Enhanced Error Handling:</b> Graceful failure recovery</li>
        </ul>
        
        <h3>🤖 AI Models Supported:</h3>
        <ul>
        <li><b>AWS Bedrock:</b> 20+ models (Claude 3.5, Nova, Llama, Mistral)</li>
        <li><b>Free Models:</b> Ollama (local), Hugging Face, OpenAI-compatible</li>
        <li><b>Offline Processing:</b> Complete privacy with local Ollama models</li>
        </ul>
        
        <h3>⚙️ Technical Excellence:</h3>
        <ul>
        <li><b>Async Architecture:</b> Modern Python asyncio with PyQt5 integration</li>
        <li><b>Resource Management:</b> Intelligent API throttling and memory cleanup</li>
        <li><b>Thread Safety:</b> Proper signal/slot communication</li>
        <li><b>Scalable Design:</b> Ready for future enhancements</li>
        </ul>
        
        <p><i>Transform your meeting transcription workflow with professional-grade async processing!</i></p>
        """
        
        msg = QMessageBox(self)
        msg.setWindowTitle("About Meeting Transcriber - Async Edition")
        msg.setText(about_text)
        msg.setIcon(QMessageBox.Information)
        msg.setStandardButtons(QMessageBox.Ok)
        
        # Set custom size for better readability
        msg.setStyleSheet("QMessageBox { min-width: 600px; }")
        
        msg.exec_()
    
    def show_async_guide(self):
        """Show async features guide"""
        guide_text = """
        <h2>🚀 Async Features Quick Guide</h2>
        
        <h3>Getting Started:</h3>
        <ol>
        <li><b>Select Audio File:</b> Choose your meeting recording</li>
        <li><b>Configure Settings:</b> Set AI model and transcription options</li>
        <li><b>Start Processing:</b> Click "Start Transcription" or "Add to Queue"</li>
        <li><b>Monitor Progress:</b> Switch to "Progress Monitor" tab</li>
        <li><b>Stay Productive:</b> Continue using the app while processing</li>
        </ol>
        
        <h3>🔄 Concurrent Processing:</h3>
        <ul>
        <li>Process up to 5 files simultaneously</li>
        <li>Each task has independent progress tracking</li>
        <li>Failed tasks don't affect other running tasks</li>
        <li>Intelligent resource management prevents API throttling</li>
        </ul>
        
        <h3>📊 Progress Monitoring:</h3>
        <ul>
        <li><b>Real-time Updates:</b> See exactly what's happening</li>
        <li><b>Time Tracking:</b> Monitor elapsed time for each task</li>
        <li><b>Status Messages:</b> Detailed progress information</li>
        <li><b>Task Management:</b> Cancel, clear, or monitor individual tasks</li>
        </ul>
        
        <h3>⚡ Performance Tips:</h3>
        <ul>
        <li>Use local Ollama models for unlimited processing</li>
        <li>Limit concurrent tasks to avoid API rate limits</li>
        <li>Clear completed tasks regularly to keep interface clean</li>
        <li>Monitor system resources during batch processing</li>
        </ul>
        
        <h3>🛠️ Troubleshooting:</h3>
        <ul>
        <li><b>Task Not Starting:</b> Check AWS credentials or model availability</li>
        <li><b>Progress Stuck:</b> Cancel and restart the task</li>
        <li><b>UI Unresponsive:</b> Check if async dependencies are installed</li>
        <li><b>High Memory Usage:</b> Reduce concurrent task limit</li>
        </ul>
        """
        
        msg = QMessageBox(self)
        msg.setWindowTitle("Async Features Guide")
        msg.setText(guide_text)
        msg.setIcon(QMessageBox.Information)
        msg.setStandardButtons(QMessageBox.Ok)
        msg.setStyleSheet("QMessageBox { min-width: 650px; }")
        msg.exec_()
    ...
    def open_documentation(self):
        ...
        # Try to open ASYNC_FEATURES.md if it exists
        if os.path.exists("ASYNC_FEATURES.md"):
            try:
                if sys.platform == 'win32':
                    subprocess.Popen(['notepad', 'ASYNC_FEATURES.md'])
                elif sys.platform == 'darwin':
                    subprocess.Popen(['open', 'ASYNC_FEATURES.md'])
                else:
                    subprocess.Popen(['xdg-open', 'ASYNC_FEATURES.md'])
            except Exception as e:
                QMessageBox.information(self, "Documentation", 
                    f"Documentation file found: ASYNC_FEATURES.md\n\n"
                    f"Please open it manually to read the complete async features guide.\n\n"
                    f"Error opening automatically: {str(e)}")
        else:
            QMessageBox.information(self, "Documentation", 
                "Documentation files:\n\n"
                "• ASYNC_FEATURES.md - Complete async features guide\n"
                "• README.txt - Installation and setup instructions\n"
                "• FREE_MODELS_SETUP.md - Free models configuration\n\n"
